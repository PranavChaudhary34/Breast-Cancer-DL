...
def predict_breast_cancer(*features):
    ...
    return {"Prediction": class_name, "Confidence (Benign %)": f"{prediction[0][1]*100:.2f}%"}
...
interface = gr.Interface(
    ...
    description="Enter values for 30 features to predict if the tumor is malignant or benign"
)
